...
public interface ReservationsApi {
    ...
    ResponseEntity<List<ReservationVO>> findReservationsByUser(@ApiParam(value = "user id",required=true ) @PathVariable("userId") Long userId,@ApiParam(value = "the begining date of search", defaultValue = "2017-09-01T00:00:00.000+0000") @RequestParam(value = "from", required = false, defaultValue="2017-09-01T00:00:00.000+0000") LocalDate from,@ApiParam(value = "the end date of search", defaultValue = "2017-09-30T00:00:00.000+0000") @RequestParam(value = "to", required = false, defaultValue="2017-09-30T00:00:00.000+0000") LocalDate to);
